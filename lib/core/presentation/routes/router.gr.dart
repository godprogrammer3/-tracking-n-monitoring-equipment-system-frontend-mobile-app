...
import '../../../features/fixing/presentation/pages/fixing_detail.dart' as _i53;
...
class AppRouter extends _i57.RootStackRouter {
  ...
  final Map<String, _i57.PageFactory> pagesMap = {
    ...
    FixingLockerDetailRoute.name: (routeData) {
      ...
      return _i57.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i52.FixingLockerDetailPage(key: args.key, title: args.title));
    },
    FixingDetailRoute.name: (routeData) {
      return _i57.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i53.FixingDetailPage());
    },
    ReportProblemLockerDetailRoute.name: (routeData) {
      ...
      return _i57.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i54.ReportProblemLockerDetailPage(
              key: args.key, title: args.title));
    },
    ReportProblemDetailRoute.name: (routeData) {
      return _i57.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i55.ReportProblemDetailPage());
    },
    SolveProblemRoute.name: (routeData) {
      return _i57.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i56.SolveProblemPage());
    },
  ...
  List<_i57.RouteConfig> get routes => [
        ...
        _i57.RouteConfig(SocialLoginTestRoute.name,
        ...
        _i57.RouteConfig(AddingEquipment.name, path: '/adding-equipment'),

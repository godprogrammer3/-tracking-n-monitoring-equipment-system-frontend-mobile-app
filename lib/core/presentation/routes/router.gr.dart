...
import '../../../features/account/presentation/pages/account.dart' as _i28;
...
import '../../../features/borrowing/presentation/pages/unlock_locker/unlock_locker.dart'
    as _i25;
import '../../../features/history/presentation/pages/history.dart' as _i23;
...
class AppRouter extends _i21.RootStackRouter {
  ...
  final Map<String, _i21.PageFactory> pagesMap = {
    ...
    UnlockLockerRoute.name: (routeData) {
      return _i21.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i25.UnlockLockerPage());
    },
    ListLockerRoute.name: (routeData) {
      return _i21.MaterialPageX<dynamic>(
          routeData: routeData, child: _i26.ListLockerPage());
    },
    ToggleLockerRoute.name: (routeData) {
      ...
      return _i21.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i27.ToggleLockerPage(key: args.key, lockerId: args.lockerId));
    },
    AccountRoute.name: (routeData) {
      return _i21.MaterialPageX<dynamic>(
          routeData: routeData, child: _i28.AccountPage());
    }
  };
        ...
        _i21.RouteConfig(HomeRoute.name, path: '/', children: [
          ...
          _i21.RouteConfig(UnlockLockerRouter.name,
              ...
              children: [
                ...
                _i21.RouteConfig(ListLockerRoute.name,
                    path: 'list_locker', parent: UnlockLockerRouter.name),
                _i21.RouteConfig(ToggleLockerRoute.name,
...
/// generated route for [_i26.ListLockerPage]
class ListLockerRoute extends _i21.PageRouteInfo<void> {
  const ListLockerRoute() : super(name, path: 'list_locker');

  static const String name = 'ListLockerRoute';
}

/// generated route for [_i27.ToggleLockerPage]
class ToggleLockerRoute extends _i21.PageRouteInfo<ToggleLockerRouteArgs> {
  ToggleLockerRoute({_i29.Key? key, required int lockerId})
      : super(name,
            path: ':lockerId',
...
/// generated route for [_i28.AccountPage]
